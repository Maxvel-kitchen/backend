# Generated by Django 4.1.4 on 2023-03-23 19:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredients', models.CharField(blank=True, max_length=1024, verbose_name='Ингредиенты')),
        ...
        migrations.AddField(
            model_name='position',
            name='sub_category',
            field=models.ManyToManyField(blank=True, related_name='positions', to='api.subcategory', verbose_name='Подкатегория'),
        ),
    ]

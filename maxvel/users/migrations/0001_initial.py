    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('link', models.URLField(max_length=128, verbose_name='Ссылка')),
            ],
            options={
                'verbose_name': 'Ссылка',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address_on_map', models.CharField(max_length=1024, verbose_name='Адрес на карте')),
                ('email', models.EmailField(max_length=255, verbose_name='Почта')),
                ('links', models.ManyToManyField(related_name='contact', to='users.link', verbose_name='Ссылки')),
            ],
            options={
